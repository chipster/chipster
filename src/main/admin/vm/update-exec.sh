...
# 2.3.2 not released yet, remember to change LATEST_VERSION
...
if [ $CURRENT_COMPARED -lt 0 ] ; then 
  ...
  echo "** Installing Arabidopsis lyrata fasta and bwa index"
  ...
  echo "** Installing Sus scrofa fasta and bwa index"
