...
curl -s http://cole-trapnell-lab.github.io/cufflinks/assets/downloads/cufflinks-2.2.1.Linux_x86_64.tar.gz | tar -xz -C ${TOOLS_PATH}/

ln -s cufflinks-2.2.1.Linux_x86_64 ${TOOLS_PATH}/cufflinks2
