# ANALYSIS "Promoter Analysis"/"ClusterBuster with Ensembl" (Does a search for known transcription factor binding sites from
# input sequences using matrices from the Jaspar database. Promoter sequences are automatically retrieved from
# a central database. Includes the Ensembl Database for Human and Mouse. Currently works only for human, mouse, rat, drosophila, and yeast data.)
...
# PARAMETER Motifs [jasper, regular] DEFAULT regular ( What form you would like the motifs to be in, Jasper MAO or regular)
...
path.cbust<-c("/home/s2686739/Desktop/Dataforchipster/cbust-linux")
...
system("cp seqs.txt /home/s2686739/seq1.txt")
