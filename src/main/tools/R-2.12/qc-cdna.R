...
# INPUT GENE_EXPRS normalized.tsv OUTPUT boxplot.pdf, densityplot.pdf, MA-plot.pdf
...
# MA plot
bitmap(file="MA-plot.pdf", width=w/72, height=h/72)
...
for(i in 1:ncol(dat2)) {
   ...
   d<-na.omit(data.frame(A=A[,i], dat=dat[,i]))
