...
# PARAMETER resolution: resolution DECIMAL FROM 0.001 TO 1 DEFAULT 0.1 (Proportion of log-ratio data points to draw. Lower values lead to smaller file sizes and faster processing.)
