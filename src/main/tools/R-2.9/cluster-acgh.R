...
if (ncol(softcalls)==0) {
  if (calls=='soft')
    stop('CHIPSTER-NOTE: No soft calls were found. Please try running with parameter calls=hard.')
...
bitmap(file='wecca.png', width=image.width/72, height=image.height/72)
