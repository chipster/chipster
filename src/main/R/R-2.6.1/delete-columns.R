# ANALYSIS Utilities/"Delete columns" (Delete the specified column from the data.)
...
# PARAMETER deletion.type [to-right, between] DEFAULT to-right (Delete column to right from column1 or between the specified columns)
