...
if(chiptype=="human" & summary.feature=="gene") {
   dat@cdfName<-"hsex10stv2hsensecdf"
   dat@annotation<-"hsex10stv2hsensecdf"
}
if(chiptype=="mouse" & summary.feature=="gene") {
   dat@cdfName<-"mmex10stv1hsensecdf"
   dat@annotation<-"mmex10stv1hsensecdf"
}
if(chiptype=="rat" & summary.feature=="gene") {
   dat@cdfName<-"rnex10stv1hsensecdf"
   dat@annotation<-"rnex10stv1hsensecdf"
}
