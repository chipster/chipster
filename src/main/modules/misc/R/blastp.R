# TOOL ncbi_blastp.R: "NCBI BLASTP" (Heuristic tool to search hits for a protein sequence from the NCBI protein sequence databases.)
...
# PARAMETER OPTIONAL db: "Database" TYPE [nr: "NCBI non-redundant proteins", pdb: "PDB proteins", swissprot: "UniProt / Swiss", refseq_protein: "RefSeq reference proteins",	pat: "Patented protein sequences", env_nr: "Metagenomic proteins", tsa_nr: "Transkriptome Shotgun Assembly proteins"] DEFAULT swissprot (Choose a database)
...
# pb settings
pb.binary <- file.path(chipster.module.path ,"pb_for_chipster")
