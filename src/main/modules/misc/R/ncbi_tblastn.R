# TOOL ncbi_tblastn.R: "Translated protein BLAST " (Heuristic tool to search hits from the NCBI nucleotide sequence databases using a protein query. Your query sequence set can contain 10 nucleotide sequences in maximum.)
