# TOOL my_blastn.R: "Nucleotide BLAST against users own nucleotide sequence set" (BLAST for searching a users own nucleotide set using a nucleotide query.)
...
general.parameters <- paste("-chipster_path /opt/chipster -no_slurm -query query.fa -out blast_results -dbnuc dbnuc.fa")
