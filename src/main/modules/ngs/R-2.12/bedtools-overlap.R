...
# OUTPUT overlap.bed 
# PARAMETER cols: "Columns to use" TYPE STRING (Specify the columns (1-based\) for the starts and ends of the features for which you'd like to compute the overlap/distance. The columns must be listed in the following order: start1,end1,start2,end2.)
