...
# PARAMETER quality: "Minimum quality score to keep" TYPE INTEGER FROM 1 TO 100 DEFAULT 5 (What is the minimum quality score to keep.)
# PARAMETER percentage: "Minimum percent of bases that must have that quality" TYPE INTEGER FROM 1 TO 100 DEFAULT 90 (What is the minimum percentage of bases that must have the specified.)
