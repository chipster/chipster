...
# PARAMETER genome: "Genome or transcriptome" TYPE [hg19: "Human genome (hg19\)", mm10: "Mouse genome (mm10\)", mm9: "Mouse genome (mm9\)", Rattus_norvegicus.Rnor_5.0.70.dna.toplevel: "Rat genome (rn5\)", rn4: "Rat genome (rn4\)", athaliana.TAIR10: "A. thaliana genome (TAIR10\)", Arabidopsis_lyrata.v.1.0.16: "A. lyrata genome (1.0.16\)", canFam2: "Dog genome (UCSC canFam2\)", ovis_aries_texel: "Sheep genome (oar3.1\)", Sus_scrofa.Sscrofa10.2.69.dna.toplevel: "Pig (sus_scrofa10.2.69\)", miRBase19_Homo_sapiens: "Human miRBase19", miRBase19_Mus_musculus: "Mouse miRBase 19", miRBase19_Rattus_norvegicus: "Rat miRBase 19", Halorubrum_lacusprofundi_ATCC_49239: "Halorubrum lacusprofundi ATCC 49239 genome", Gasterosteus_aculeatus.BROADS1.70: "Gasterosteus aculeatus genome (BROADS1.67\)"] DEFAULT hg19 (Genome or transcriptome that you would like to align your reads against.)
