# TOOL prinseq-trimmer.R: "General reads trimmer" (Trims nucleotide sequences from a reads file based on given criteria. This tool utilizes PRINSEQ program.)
...
# PARAMETER OPTIONAL trim.to.len: "Trim to length" TYPE INTEGER (Trim all sequence from the 3-prime-end to result in sequence with this length.)
# PARAMETER OPTIONAL trim.left: "Trim left" TYPE INTEGER (Trim sequence at the 5-prime-end by given number of positions.)
# PARAMETER OPTIONAL trim.right: "Trim right" TYPE INTEGER (Trim sequence at the 3-prime-end by given number of positions.)
