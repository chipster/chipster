# TOOL ngs-dea-edger.R: "Differential expression analysis using edgeR" (Differential expression analysis of genomic features using the edgeR Bioconductor package. You can create the input count table and phenodata file by the tool Utilites - Define NGS experiment.)
...
# Create a table with the original counts per sample together with the statistical tests results
