...
# OUTPUT bwa.bam.bai 
# OUTPUT bwa.log 
# PARAMETER genome: "Genome or transcriptome" TYPE [hg19.fa: "Human genome (hg19\)", mm10.fa: "Mouse genome (mm10\)", mm9.fa: "Mouse genome (mm9\)", rn4.fa: "Rat genome (rn4\)", mmu_miRB17mature.fa: "Mouse miRBase17", ovis_aries_texel.fa: "Sheep (oar3.1\)", Arabidopsis_lyrata.v.1.0.16.fa: "Arabidopsis Lyrata (1.0.16\)" ] DEFAULT mm9.fa (Genome or transcriptome that you would like to align your reads against.)
