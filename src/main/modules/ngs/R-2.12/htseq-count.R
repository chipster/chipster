...
# AMS added chr/nochr option 3.2.2013
# MK added chr-location information to the output 6.5.2013
...
if(print.coord == "no") {
	...
	htseq.binary <- file.path(chipster.tools.path, "htseq", "htseq-count-chr")
}
...
if(print.coord == "no") {
	...
	names(dat) <- c("id", "chr", "start", "end", "strand", "count")
}
