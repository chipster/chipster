...
# PARAMETER organism: "Organism" TYPE [Homo_sapiens.GRCh37.68.chr.gtf: "Human (hg19.68)", Mus_musculus.GRCm38.68.chr.gtf: "Mouse (mm10.68)", Mus_musculus.NCBIM37.62.chr.gtf: "Mouse (mm9.62)", Rattus_norvegicus.RGSC3.4.68.chr.gtf: "Rat (rn4.68)"] DEFAULT Homo_sapiens.GRCh37.68.chr.gtf (Which organism is your data from.)
