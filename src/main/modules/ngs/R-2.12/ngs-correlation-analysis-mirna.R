# TOOL ngs-correlation-analysis-mirna.R: "Correlate miRNA with gene expression array data" (Performs a statistical test to detect miRNA targets whose expression is significantly positively or negatively correlated to the expression of the miRNA.)
