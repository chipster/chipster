# TOOL dimont-extract-data.R: "Dimont data extractor" (Extracts genomic regions specified in a BED-like file format in the annotated FastA format as required by Dimont.)
...
# PARAMETER genome: "Genome" TYPE [hg19: "Human genome (hg19\)", mm10: "Mouse genome (mm10\)", rn4: "Rat genome (rn4\)", Halorubrum_lacusprofundi_ATCC_49239: "Halorubrum lacusprofundi ATCC 49239 genome", Sus_scrofa.Sscrofa10.2.69.dna.toplevel: "Pig (sus_scrofa10.2.69\)",  athaliana.TAIR10: "A. thaliana genome (TAIR10\)", Arabidopsis_lyrata.v.1.0.16: "A. lyrata genome (1.0.16\)", ovis_aries_texel: "Sheep genome (oar3.1\)"] DEFAULT hg19 (Genome or transcriptome that the genomic regions refer to.)
...
command<-paste("perl",tool,genome.fa,"regions.bed",chromcol,startcol,seccol,seccoord,width,statcol,"extracted.fa");
