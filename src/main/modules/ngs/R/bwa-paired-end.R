# TOOL bwa-paired-end.R: "BWA ALN for paired end reads" (BWA aligns reads to genomes. Results are sorted and indexed BAM files, which are ready for viewing in the Chipster genome browser. 
