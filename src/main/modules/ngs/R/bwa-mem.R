...
# OUTPUT bwa.bam.bai 
# OUTPUT bwa.log 
# PARAMETER organism: "Organism" TYPE [Arabidopsis_thaliana.TAIR10.28, Bos_taurus.UMD3.1, Canis_familiaris.CanFam3.1, Drosophila_melanogaster.BDGP6, Felis_catus.Felis_catus_6.2, Gallus_gallus.Galgal4, Gasterosteus_aculeatus.BROADS1, Halorubrum_lacusprofundi_atcc_49239.GCA_000022205.1.28, Homo_sapiens.GRCh37.75, Homo_sapiens.GRCh38, Homo_sapiens_mirna, Medicago_truncatula.GCA_000219495.2.28, Mus_musculus.GRCm38, Mus_musculus_mirna, Ovis_aries.Oar_v3.1,Populus_trichocarpa.JGI2.0.28, Rattus_norvegicus_mirna, Rattus_norvegicus.Rnor_5.0, Rattus_norvegicus.Rnor_6.0, Schizosaccharomyces_pombe.ASM294v2.28, Solanum_tuberosum.3.0.28, Sus_scrofa.Sscrofa10.2, Vitis_vinifera.IGGP_12x.28, Yersinia_enterocolitica_subsp_palearctica_y11.GCA_000253175.1.28, Yersinia_pseudotuberculosis_ip_32953_gca_000047365_1.GCA_000047365.1.28] DEFAULT Homo_sapiens.GRCh38 (Genome that you would like to align your reads against.)
