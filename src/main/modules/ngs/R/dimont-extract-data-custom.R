# TOOL dimont-extract-data-custom.R: "Dimont data extractor custom" (Extracts genomic regions specified in a BED-like file format in the annotated FastA format as required by Dimont.)
...
# INPUT genome.fa: Genome TYPE FASTA (The input genome to which the genomic regions refer.)
