# TOOL bwa-mem-paired-end.R: "BWA MEM for peired-end reads" (BWA aligns reads to genomes and transcriptomes using BWA MEM algorithm. Results are sorted and indexed bam files, which are ready for viewing in the Chipster genome browser. 
