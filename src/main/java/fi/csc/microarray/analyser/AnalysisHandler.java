...
public interface AnalysisHandler {
	 ...
	 */
	public AnalysisJob createAnalysisJob(JobMessage message, ToolDescription description, ResultCallback resultHandler) throws AnalysisException;
	 ...
	 * @see #supports(String)
	 */
	public ToolDescription handle(File moduleDir, String toolFilename, Map<String, String> parameters) throws AnalysisException;
