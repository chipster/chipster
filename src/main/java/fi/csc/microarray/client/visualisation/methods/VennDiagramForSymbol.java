...
public class VennDiagramForSymbol extends VennDiagram implements PropertyChangeListener {

	private static final String IDENTIFIER_COLUMN = "/column/symbol";

	public VennDiagramForSymbol(VisualisationFrame frame) {
		super(frame);
	}
	...
	public JComponent getVisualisation(List<DataBean> datas) throws Exception {
		...
		chartPanel = makePanel(new JFreeChart("Venn-diagram for symbol", plot));
