...
public class ModifiedPlot extends Plot implements org.jfree.chart.plot.ContourValuePlot, ValueAxisPlot, 
	PropertyChangeListener, Serializable/*, Cloneable*/ {
	...
	public static void main(String[] args) {
		...
		org.jfree.chart.axis.ColorBar colors = new org.jfree.chart.axis.ColorBar("Colourbar");
		ValueAxis xAxis = new LogarithmicAxis("x");
		ValueAxis yAxis = new LogarithmicAxis("y");
    ...
    private org.jfree.chart.axis.ColorBar colorBar = null;
    ...
    private transient org.jfree.chart.ClipPath clipPath = null;
    ...
    */
    public ModifiedPlot(org.jfree.data.contour.ContourDataset dataset,
        ...
        this.toolTipGenerator = new org.jfree.chart.labels.StandardContourToolTipGenerator();
     ...
     */
    public void setDataset(org.jfree.data.contour.ContourDataset dataset) {
        
        // if there is an existing dataset, remove the plot from the list of 
        // change listeners...
    	org.jfree.data.contour.ContourDataset existing = this.dataset;
        if (existing != null) {
     ...
     * @param axis The new axis (null permitted).
     */
    public void setColorBarAxis(org.jfree.chart.axis.ColorBar axis) {
...
//        }
    ...
    public void render(Graphics2D g2, Rectangle2D dataArea,
    	...
    	org.jfree.data.contour.ContourDataset data = getDataset();
        if (data != null) {

        	org.jfree.chart.axis.ColorBar zAxis = getColorBar();
...
//              if (s.contains(rect) || s.intersects(rect)) {
                ...
                // reused.
                org.jfree.chart.entity.ContourEntity entity = new org.jfree.chart.entity.ContourEntity(
...
*/
     ...
     */
    public void setToolTipGenerator(org.jfree.chart.labels.ContourToolTipGenerator generator) {
     ...
     */
    public void setClipPath(org.jfree.chart.ClipPath clipPath) {
     ...
     * @return The range.
     */
    public Range visibleRange(org.jfree.data.contour.ContourDataset data, Range x, Range y) {
        Range range = null;
    ...
    public Object clone() throws CloneNotSupportedException {
        MyPlot clone = (MyPlot) super.clone();
        ...
        clone.domainMarkers = (List<Marker>) ObjectUtilities.deepClone(
            this.domainMarkers
        );
        clone.rangeMarkers = (List<Marker>) ObjectUtilities.deepClone(
            this.rangeMarkers
        );
        clone.annotations = (List<XYAnnotation>) ObjectUtilities.deepClone(this.annotations);
