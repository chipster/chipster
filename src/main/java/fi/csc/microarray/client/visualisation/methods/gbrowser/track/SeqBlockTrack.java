...
public class SeqBlockTrack extends Track {
	...
	public SeqBlockTrack(View view, File file, Class<? extends AreaRequestHandler> handler, FileParser inputParser, Color color, long minBpLength, long maxBpLength) {
...
//				Object valueObj = read.values.get(ColumnType.VALUE);
				...
				// } else
				{
					...
					if (seq != null) {
						...
						seq = "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA" + "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA".substring(0, seqLength);
					}
