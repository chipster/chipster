...
public class WorkflowWriter {
	...
	private HashMap<Dataset, String> resultIdMap;
	 ...
	 */
	public synchronized StringBuffer writeWorkflow(Dataset root) throws IOException {
		...
		this.resultIdMap = new HashMap<Dataset, String>();
	 ...
	 */
	private void generateStep(StringBuffer script, Operation operation, LinkedList<Dataset> results) {
	...
	private void generateHeader(StringBuffer script, Dataset root) {
