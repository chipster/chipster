...
public class BasicModule implements Module {
	...
	public static class VisualisationMethods {
		...
		public static VisualisationMethod EXTERNAL_BROWSER = new VisualisationMethod("Open in external web browser", ExternalBrowserViewer.class, VisualConstants.EMPTY_MENUICON, Integer.MAX_VALUE, -1);
	}
