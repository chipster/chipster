...
public class MicroarrayModule implements Module {
	...
	public static class VisualisationMethods {
		...
		public static VisualisationMethod GBROWSER = new VisualisationMethod("Genome browser", GenomeBrowser.class, VisualConstants.GB_MENUICON, 1, -1, "genomeBrowser.html");
