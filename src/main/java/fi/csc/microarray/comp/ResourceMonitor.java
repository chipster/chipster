 ...
 * 
 * <p>
 * Get the list of current processes from the ProcessProvider and collect the
 * combined memory usage of each process and its child processes every second.
 * When the process disappears from the list of ProcessProvider, it's monitoring
 * results are removed as well.
 * </p>
 * 
 * <p>
